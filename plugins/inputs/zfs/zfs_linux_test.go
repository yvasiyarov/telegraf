...
func getPoolIostatMetrics2() map[string]interface{} {
	return map[string]interface{}{
		...
		"operations_write":              int64(2709),
		"bandwidth_read":                int64(0),
		"bandwidth_write":               int64(319773047),
		"total_wait_read":               int64(0),
		"total_wait_write":              int64(94619655),
		"disk_wait_read":                int64(0),
		"disk_wait_write":               int64(4768441),
		"syncq_wait_read":               int64(0),
		"syncq_wait_write":              int64(3885),
		"asyncq_wait_read":              int64(0),
		"asyncq_wait_write":             int64(90319204),
		"scrub_wait":                    int64(0),
		...
		"asyncq_write_operations_pend":  int64(650),
		"asyncq_write_operations_activ": int64(7),
...
func getPoolIostatMetrics() map[string]interface{} {
	return map[string]interface{}{
		...
		"operations_read":               int64(0),
		"operations_write":              int64(51),
		"bandwidth_read":                int64(0),
		"bandwidth_write":               int64(331219),
		"total_wait_read":               int64(0),
		"total_wait_write":              int64(31293),
		"disk_wait_read":                int64(0),
		"disk_wait_write":               int64(13810),
		"syncq_wait_read":               int64(0),
		"syncq_wait_write":              int64(653),
		"asyncq_wait_read":              int64(0),
		"asyncq_wait_write":             int64(18620),
		"scrub_wait":                    int64(0),
		"syncq_read_operations_pend":    int64(0),
		"syncq_read_operations_activ":   int64(0),
		"syncq_write_operations_pend":   int64(0),
